...
double fir_tmp[200];                 // Temp array for coefficient calculations which are performed in 64bit
short fir_active[200];                       // DSP filter array holding the coefficient as 32bit (short)
